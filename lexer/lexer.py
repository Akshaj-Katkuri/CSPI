        ...
        while self.current_char is not None:
            if self.current_char in " \t":
                ...
                if self.get_next_char == ">":
                    ...
                    self.advance()
                    tokens.append(
                        Token(TYPE_ARROW, "**", pos_start=pos_start, pos_end=self.pos)
                    )
                else:
                ...
                if self.get_next_char() == "*":
                    ...
                    self.advance()
                    tokens.append(
                        Token(TYPE_POW, "**", pos_start=pos_start, pos_end=self.pos)
                    )
                else:
                ...
                tokens.append(Token(TYPE_LCURL, pos_start=self.pos))
                self.advance()
            elif self.current_char == "}":
                tokens.append(Token(TYPE_RCURL, pos_start=self.pos))
                self.advance()
            elif self.current_char == "!":
    ...
    def make_number(self):
        ...
        while self.current_char is not None and (
            ...
            if self.current_char.isalpha():
                ...
                if dot_count == 1:
                    break  # TODO: implement raise error here
                dot_count += 1
                num_str += "."
            else:
        ...
        if dot_count == 0:
            ...
            return Token(
                TYPE_FLOAT, float(num_str), pos_start=pos_start, pos_end=self.pos
            )
